...
public class reEn : MonoBehaviour
{
    ...
    private float highlightTime = 20.5f; // tiempo en segundos que el objeto estará resaltado
    public Material highlightColor; // color de resaltado del objeto

    public Material reticuloM;
    ...
    private float displayTime = 20.5f; // tiempo que se muestra el panel en segundos
    ...
    void ResetObjectHighlight()
    {
        ...
        objectToTouch.GetComponent<Renderer>().material = reticuloM;
