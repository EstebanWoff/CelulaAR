...
public class aparatoGolgi : MonoBehaviour
{
    ...
    private float highlightTime = 26f; // tiempo en segundos que el objeto estará resaltado
    public Material highlightColor; // color de resaltado del objeto

    public Material aparatoGolgiM;
    ...
    private float displayTime = 26f; // tiempo que se muestra el panel en segundos
    ...
    void ResetObjectHighlight()
    {
        ...
        objectToTouch.GetComponent<Renderer>().material = aparatoGolgiM;
