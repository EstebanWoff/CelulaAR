...
public class nucleolo : MonoBehaviour
{
    ...
    private float highlightTime = 19f; // tiempo en segundos que el objeto estará resaltado
    public Material highlightColor; // color de resaltado del objeto

    public Material nucleoloM;
    ...
    private float displayTime = 19f; // tiempo que se muestra el panel en segundos
    ...
    void ResetObjectHighlight()
    {
        ...
        objectToTouch.GetComponent<Renderer>().material = nucleoloM;
